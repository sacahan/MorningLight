...
export const Auth: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-rose-50">
      <div className="card w-full max-w-md text-center space-y-8 py-10 px-8">
        <div className="space-y-4">
          <Mascot expression={loading ? 'sleepy' : 'happy'} className="w-24 h-24 mx-auto" />
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-left">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 rounded-xl border-2 border-rose-100 focus:border-rose-400 focus:outline-none transition-colors font-medium"
                value={email}
          ...
          <div className="space-y-2">
            <label className="text-sm font-bold text-slate-600 ml-1">密碼</label>
            <div className="relative">
          ...
          <button
            type="submit"
            disabled={loading}
            className="btn-primary w-full py-4 flex items-center justify-center gap-2 text-lg shadow-md hover:shadow-lg active:translate-y-0.5 transition-all"
          >
            {loading ? '請稍候...' : (
              <>
        ...
        <button
          ...
          className="w-full text-sm font-bold text-rose-400 hover:text-rose-500 flex items-center justify-center gap-1 transition-colors"
        >
